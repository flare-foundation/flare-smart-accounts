...
resultInfo = {
  ...
  "incorrect-shift": [
    ...
    "https://github.com/crytic/slither/wiki/Detector-Documentation#shift-parameter-mixup",
  ],
...
for (const det of detectors) {
  ...
  console.log(
    `\u001b[${colors[det.impact]}m${info}  ('${det.check}', impact: ${det.impact}, confidence: ${det.confidence}):\u001b[0m`
  );
