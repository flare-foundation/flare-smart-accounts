...
fs.writeFileSync(`deployment/deploys/${network}_mock.json`, JSON.stringify(contracts, null, 2));
fs.unlinkSync(outputPath);
console.log(`Saved deployed addresses to deployment/deploys/${network}_mock.json`);
